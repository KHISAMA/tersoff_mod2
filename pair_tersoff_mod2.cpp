...
/* ----------------------------------------------------------------------
   Contributing author: Aidan Thompson (SNL) - original Tersoff implementation
                        ...
                        Contributing author: Kaoru Hisama (Shinshu University) - Tersoff mod2 implementation
------------------------------------------------------------------------- */


#include "pair_tersoff_mod2.h"
...
PairTersoffMOD2::PairTersoffMOD2(LAMMPS *lmp) : PairTersoff(lmp) {}

/* ---------------------------------------------------------------------- */

void PairTersoffMOD2::read_file(char *file)
{
  memory->sfree(params);
  params = nullptr;
  nparams = maxparam = 0;
...
void PairTersoffMOD2::setup_params()
{
  int i,j,k,m,n;
...
double PairTersoffMOD2::zeta(Param *param, double rsqij, double rsqik,
...
double PairTersoffMOD2::ters_fc(double r, Param *param)
{
...
double PairTersoffMOD2::ters_fc_d(double r, Param *param)
{
  double ters_R = param->bigr;
  double ters_D = param->bigd;
...
double PairTersoffMOD2::ters_bij(double zeta, Param *param)
{
...
double PairTersoffMOD2::ters_bij_d(double zeta, Param *param)
{
  double tmp = param->beta * zeta;
...
void PairTersoffMOD2::ters_zetaterm_d(double prefactor,
